...
struct PlacesLoader {
    ...
    let apiKey = "AIzaSyCDov3tESBx9ci_N7CNcRQnzI6gFd61DoM"
            ...
            if let error = error {
                ...
                if httpResponse.statusCode == 200 {
                    ...
                    do {
                        ...
                        handler(responseDict, error as! NSError)
    ...
    func loadDetailInfomration(forPlace: Places, handler: @escaping(NSDictionary?, NSError?) -> Void) {
